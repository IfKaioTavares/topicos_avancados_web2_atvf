        ...
        {systemStats ? (
          <>
            ...
            <section className="surface" style={{ padding: '2rem' }}>
              <div className="card-header" style={{ marginBottom: '1.5rem' }}>
                <h2 className="card-header__title">Status do sistema</h2>
                <span className="support-text">
                  Panorama da infraestrutura de suporte e serviços críticos.
                </span>
              </div>

              <div className="grid grid--cols-3" style={{ gap: '1.25rem' }}>
                <div className="surface surface--muted" style={{ padding: '1.4rem', textAlign: 'center', borderRadius: 'var(--radius-lg)' }}>
                  <div
                    style={{
                      width: '52px',
                      height: '52px',
                      ...
                      display: 'grid',
                      placeItems: 'center',
                      background: systemStats.systemHealth?.database ? 'rgba(34,197,94,0.16)' : 'rgba(248,113,113,0.18)',
                      color: systemStats.systemHealth?.database ? '#15803d' : '#b91c1c',
                    }}
                  >
                    <Settings size={22} />
                  </div>
                  <h3 className="card-header__title" style={{ marginTop: '0.8rem', fontSize: '1rem' }}>
                    Banco de dados
                  </h3>
                  <span
                    className="support-text"
                    style={{ color: systemStats.systemHealth?.database ? '#15803d' : '#b91c1c', fontWeight: 600 }}
                  >
                    {systemStats.systemHealth?.database ? 'Conectado' : 'Desconectado'}
                  </span>
                </div>
                ...
                <div className="surface surface--muted" style={{ padding: '1.4rem', textAlign: 'center', borderRadius: 'var(--radius-lg)' }}>
                  ...
                  <span className="support-text" style={{ color: '#15803d', fontWeight: 600 }}>
                    Operacionais
                  </span>
                </div>
                ...
                <div className="surface surface--muted" style={{ padding: '1.4rem', textAlign: 'center', borderRadius: 'var(--radius-lg)' }}>
                  ...
                  <span className="support-text" style={{ color: '#4338ca', fontWeight: 600 }}>
                    {systemStats.onlineUsers || 'N/A'}
                  </span>
                </div>
              </div>
            </section>
